...
- state (optional):
    ...
    def __init__(
        ...
        binWidth: typing.Optional[NumberType] = None,
        binNumber: typing.Optional[NumberType] = None,
...
setattr(AntdHistogram, "__init__", _explicitize_args(AntdHistogram.__init__))
