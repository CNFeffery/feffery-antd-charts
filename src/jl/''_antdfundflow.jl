...
export ''_antdfundflow

"""
    ''_antdfundflow(;kwargs...)
...
- `key` (String; optional)
- `layout` (optional): . layout has the following type: lists containing elements 'nodesep', 'ranksep'.
Those elements have the following types:
  - `nodesep` (Real; optional)
  - `ranksep` (Real; optional)
...
- `width` (Real; optional)
"""
function ''_antdfundflow(; kwargs...)
        available_props = Symbol[:id, :autoFit, :behaviors, :className, :data, :edgeCfg, :height, :key, :layout, :loading_state, :markerCfg, :minimapCfg, :nodeCfg, :style, :width]
        wild_props = Symbol[]
        return Component("''_antdfundflow", "AntdFundFlow", "feffery_antd_charts", available_props, wild_props; kwargs...)
end
