...
function __init__()
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.2.0-rc1/feffery_antd_charts/async-fact-shared.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.2.0-rc1/feffery_antd_charts/async-graphs.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.2.0-rc1/feffery_antd_charts/async-plots.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.2.0-rc1/feffery_antd_charts/async-fact-shared.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.2.0-rc1/feffery_antd_charts/async-graphs.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.2.0-rc1/feffery_antd_charts/async-plots.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.2.0-rc1/feffery_antd_charts/feffery_antd_charts.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.2.0-rc1/feffery_antd_charts/feffery_antd_charts.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
