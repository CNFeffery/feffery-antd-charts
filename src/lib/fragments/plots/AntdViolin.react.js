...
import { propTypes, defaultProps } from '../../components/AntdViolin.react';
...
export default class AntdViolin extends Component {
    ...
    render() {
        ...
        config.violinStyle = cloneDeep(violinStyle)
        // 若violinStyle具有自定义函数func属性
        if (violinStyle?.func) {
            config.violinStyle = eval(violinStyle.func)
        }
...
AntdViolin.defaultProps = defaultProps;
AntdViolin.propTypes = propTypes;