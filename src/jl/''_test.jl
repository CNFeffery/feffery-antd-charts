...
"""
    ''_test(;kwargs...)
    ''_test(children::Any;kwargs...)
    ''_test(children_maker::Function;kwargs...)
...
function ''_test(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("''_test", "Test", "feffery_antd_charts", available_props, wild_props; kwargs...)
end

''_test(children::Any; kwargs...) = ''_test(;kwargs..., children = children)
''_test(children_maker::Function; kwargs...) = ''_test(children_maker(); kwargs...)
