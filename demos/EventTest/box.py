...
@app.callback(
    ...
    [Input('box-demo', 'recentlyTooltipChangeRecord'),
     Input('box-demo', 'recentlyBoxClickRecord'),
     Input('box-demo', 'recentlyLegendInfo')]
)
def demo(recentlyTooltipChangeRecord,
    ...
    return json.dumps(
        dict(
            ...
            recentlyBoxClickRecord=recentlyBoxClickRecord,
