...
@app.callback(
    ...
    [Input('wordcloud-demo', 'recentlyTooltipChangeRecord'),
     Input('wordcloud-demo', 'recentlyWordClickRecord'),
     Input('wordcloud-demo', 'recentlyLegendInfo')]
)
def demo(recentlyTooltipChangeRecord,
    ...
    return json.dumps(
        dict(
            ...
            recentlyWordClickRecord=recentlyWordClickRecord,
