...
import { propTypes, defaultProps } from '../../components/AntdRose.react';
...
export default class AntdRose extends Component {
    ...
    render() {
        ...
        // 风玫瑰样式
        config.sectorStyle = cloneDeep(sectorStyle)
        // 若sectorStyle具有自定义函数func属性
        if (sectorStyle?.func) {
            config.pieStyle = eval(sectorStyle.func)
        }
...
AntdRose.defaultProps = defaultProps;
AntdRose.propTypes = propTypes;