...
function __init__()
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.0.1-rc14/feffery_antd_charts/feffery_antd_charts.min.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/feffery_antd_charts@0.0.1-rc14/feffery_antd_charts/feffery_antd_charts.min.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
